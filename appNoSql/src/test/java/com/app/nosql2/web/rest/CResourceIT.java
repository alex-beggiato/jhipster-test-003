...
import com.app.nosql2.IntegrationTest;
...
class CResourceIT {
    ...
    void getAllCS() throws Exception {
        ...
        restCMockMvc
            ...
            .andExpect(jsonPath("$.[*].entCCCcod").value(hasItem(DEFAULT_ENT_CC_CCOD)))
            .andExpect(jsonPath("$.[*].entCCCdsc").value(hasItem(DEFAULT_ENT_CC_CDSC)));
    }
    ...
    void getC() throws Exception {
        ...
        restCMockMvc
            ...
            .andExpect(jsonPath("$.entCCCcod").value(DEFAULT_ENT_CC_CCOD))
            .andExpect(jsonPath("$.entCCCdsc").value(DEFAULT_ENT_CC_CDSC));
    }
