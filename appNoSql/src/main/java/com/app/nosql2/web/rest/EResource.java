...
import com.app.nosql2.repository.ERepository;
...
/**
 * REST controller for managing {@link com.app.nosql2.domain.E}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EResource {
    ...
    private static final String ENTITY_NAME = "appNoSqlE";
