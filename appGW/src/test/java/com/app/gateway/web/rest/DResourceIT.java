...
import com.app.gateway.repository.DRepository;
...
class DResourceIT {
    ...
    private static final String DEFAULT_ENT_DD_DCOD = "AAAAAAAAAA";
    private static final String UPDATED_ENT_DD_DCOD = "BBBBBBBBBB";

    private static final String DEFAULT_ENT_DD_DDSC = "AAAAAAAAAA";
    private static final String UPDATED_ENT_DD_DDSC = "BBBBBBBBBB";
    ...
    public static D createEntity(EntityManager em) {
        D d = new D().uid(DEFAULT_UID).entDDDcod(DEFAULT_ENT_DD_DCOD).entDDDdsc(DEFAULT_ENT_DD_DDSC);
        return d;
    }
    ...
    public static D createUpdatedEntity(EntityManager em) {
        D d = new D().uid(UPDATED_UID).entDDDcod(UPDATED_ENT_DD_DCOD).entDDDdsc(UPDATED_ENT_DD_DDSC);
        return d;
    }
    ...
    void createD() throws Exception {
        ...
        assertThat(testD.getUid()).isEqualTo(DEFAULT_UID);
        assertThat(testD.getEntDDDcod()).isEqualTo(DEFAULT_ENT_DD_DCOD);
        assertThat(testD.getEntDDDdsc()).isEqualTo(DEFAULT_ENT_DD_DDSC);
    }
    ...
    void getAllDS() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].entDDDcod")
            .value(hasItem(DEFAULT_ENT_DD_DCOD))
            .jsonPath("$.[*].entDDDdsc")
            .value(hasItem(DEFAULT_ENT_DD_DDSC));
    }
    ...
    void getD() {
        ...
        webTestClient
            ...
            .jsonPath("$.entDDDcod")
            .value(is(DEFAULT_ENT_DD_DCOD))
            .jsonPath("$.entDDDdsc")
            .value(is(DEFAULT_ENT_DD_DDSC));
    }
    ...
    void putNewD() throws Exception {
        ...
        updatedD.uid(UPDATED_UID).entDDDcod(UPDATED_ENT_DD_DCOD).entDDDdsc(UPDATED_ENT_DD_DDSC);
        ...
        D testD = dList.get(dList.size() - 1);
        assertThat(testD.getUid()).isEqualTo(UPDATED_UID);
        assertThat(testD.getEntDDDcod()).isEqualTo(UPDATED_ENT_DD_DCOD);
        assertThat(testD.getEntDDDdsc()).isEqualTo(UPDATED_ENT_DD_DDSC);
    }
    ...
    void partialUpdateDWithPatch() throws Exception {
        ...
        partialUpdatedD.uid(UPDATED_UID);
    ...
    void fullUpdateDWithPatch() throws Exception {
        ...
        partialUpdatedD.uid(UPDATED_UID).entDDDcod(UPDATED_ENT_DD_DCOD).entDDDdsc(UPDATED_ENT_DD_DDSC);
