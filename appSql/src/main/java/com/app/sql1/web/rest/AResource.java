...
/**
 * REST controller for managing {@link com.app.sql1.domain.A}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AResource {
    ...
    private static final String ENTITY_NAME = "appSqlA";
    ...
    public ResponseEntity<A> partialUpdateA(@PathVariable(value = "id", required = false) final Long id, @RequestBody A a)
        ...
        Optional<A> result = aRepository
            ...
            .map(existingA -> {
                if (a.getUid() != null) {
                    existingA.setUid(a.getUid());
                }
                if (a.getEntAAAcod() != null) {
                    existingA.setEntAAAcod(a.getEntAAAcod());
                }
                if (a.getEntAAAdsc() != null) {
                    existingA.setEntAAAdsc(a.getEntAAAdsc());
                }
