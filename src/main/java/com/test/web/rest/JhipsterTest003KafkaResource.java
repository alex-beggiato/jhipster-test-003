...
@RestController
@RequestMapping("/api/jhipster-test-003-kafka")
public class JhipsterTest003KafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterTest003KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterTest003KafkaResource(KafkaProperties kafkaProperties) {
