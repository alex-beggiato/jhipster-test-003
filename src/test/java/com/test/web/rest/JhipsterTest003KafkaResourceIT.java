...
import com.test.config.KafkaProperties;
...
class JhipsterTest003KafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterTest003KafkaResource kafkaResource = new JhipsterTest003KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-test-003-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-test-003-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
